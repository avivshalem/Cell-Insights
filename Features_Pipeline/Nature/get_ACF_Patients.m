...
semilogy(fitted_curve_x, fitted_curve_y, 'color',param.markertype,'Marker',param.markertype2, 'LineWidth', 0.1);
           end
%            plot(tll0*dt*tlag,(m33),'color',param.markertype,'Marker',param.markertype2,'linewidth',0.5); hold on;
